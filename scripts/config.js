...
const TRANSLATION_SUPPORTED_LANGUAGES = [
    "en",
    "ar",
    "bn",
    "cs",
...
let vars;
let varsResolve,
    varsPromise = new Promise((resolve) => (varsResolve = resolve));
    ...
    vars = await new Promise((resolve) => {
        chrome.storage.sync.get(
            [
                ...
                "uncensorAdultContentAutomatically",
                "uncensorSensitiveContentAutomatically",
                "useOldStyleReply",
                "enableAd",
                "acknowledgedCssAccess",
                "disableProfileCustomizations",
                "openNotifsAsModal",
                ...
                "muteVideos",
                "dontPauseVideos",
                "showUserPreviewsOnMobile",
                "systemDarkMode",
                "localizeDigit",
                "disableRetweetHotkey",
                "disableLikeHotkey",
                "disableFindHotkey",
